...
const Admin = ({ user }) => {
  ...
  return <>{
    <div className='ml-60 flex justify-between '>
      ...
      <video id = "video" src={`${server}/${lecture.video}`} width={"100%"} controls controlsList="no download noremoteplayback" disablePictureInPicture disableRemotePlayback autoPlay onEnded={() => addProgress(lecture._id)}></video>
      <script>
